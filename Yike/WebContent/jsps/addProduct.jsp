   ...
   <tr>
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom" style="text-align: center"><span class="STYLE1">添加产品信息</span></td>
              </tr>
     </table>
   	 </td>          
    </tr>
    ...
    <form action="addproduct.action" method="post" enctype="multipart/form-data">
    	...
    	<tr>
    		...
    		<td><input type="text" name="productname" style="width:300px;height:20px" ></td>
    	</tr>
    	<tr>
